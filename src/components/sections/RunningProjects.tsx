    ...
    <section className="relative w-full py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-blackish-light via-blue-950 to-blackish-light text-white overflow-hidden">
      ...
      <div className="relative text-center mb-16 px-6 z-10">
        ...
        <p className="mt-6 text-gray-300 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
          Currently building tomorrow’s landmarks with passion and precision.
        </p>
        <p className="mt-2 text-gray-400 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
          Explore our ongoing projects that define innovation and progress in
          modern architecture.
        </p>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 px-6 md:px-10 lg:px-12">
        {projects.map((project, index) => (
          <div
            key={index}
            className="group relative rounded-2xl overflow-hidden shadow-xl bg-gradient-to-b from-blue-900/40 via-black/60 to-blue-950/40 border border-white/10 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:border-blue-600/30"
          >
            {/* Project Image */}
            ...
            <div className="relative z-10 p-6 flex flex-col justify-between h-full">
              ...
              <div className="mt-6 flex items-center gap-3 relative z-50">
                ...
                <button
                  onClick={() => router.push(project.link)}
                  className="px-5 py-2 rounded-full text-sm sm:text-base font-medium text-blue-400 border border-blue-400/40 bg-transparent hover:bg-blue-900/30 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                >
                  {project.visitLabel}
                </button>
              </div>
